...
testNumDim[a_?ArrayQ]:=((Dimensions[a]=={6,6})&&And@@(NumericQ/@Flatten[a]));


rpWLayerModel[cijs:{_?ArrayQ..},rhos:{_NumericQ..},thicknesses:{___NumericQ}]/;
